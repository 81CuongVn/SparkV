            ...
            <body>
                ...
                <section className="container-md">
                    ...
                    <section id="home" style={{ width: "100%", height: "100%", display: "flex", marginTop: "125px", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "20px", textAlign: "center", margin: "7% 0" }}>
                        ...
                        <p style={{ width: "100%", fontSize: "15px", textAlign: "left", color: "rgb(255, 255, 255, .6)"}}>Last updated March 21st, 2022</p>
                        <p style={{ color: "rgb(255, 255, 255, .6)" }}>By using SparkV, you agree that you have read and accepted to our privacy policy. If you have any questions or concerns regarding our policy, you can email us here: <Link href="mailto:kingch1ll012@gmail.com">kingch1ll012@gmail.com</Link></p>
                        <p style={{ color: "rgb(255, 255, 255, .6)" }}>test</p>
                    </section>
                </section>
            </body>
        </>
