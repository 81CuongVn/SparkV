...
module.exports = {
	...
	async execute(bot, message) {
		...
		const channel = message.channel?.guild?.channels?.cache.get(data.plugins?.logging?.channel) || await message.channel?.guild?.channels?.fetch(data.plugins?.welcome?.channel);
