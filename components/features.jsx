...
export default function Features({ name, features }) {
  return (
    <section id="features" style={{ paddingBottom: "12rem" }}>
      <h1 className="text-center text-white" style={{ fontWeight: "600;" }}>Why use {name}?</h1>
      <p className="text-center" style="color: #fff9;font-size: 20px;font-family: Satoshi-Regular, sans-serif;text-align: center;">SparkV is loved by more than <strong>157,000</strong> users as an outstanding bot with <a className="gr-blue">Music</a>, <a className="gr-yellow">Memes</a>, <a className="gr-yellow">Money</a>, and more.</p>
      {features.forEach(f => {
        if (f.align === "left") {
